<template>
  <div class="css-rtl-container">
    <button @click="applyLTR">LTR 적용</button>
    <button @click="applyRTL">RTL 적용</button>
    <div :style="changeDirection" class="list-container">
      <ul>
        <li>test 1</li>
        <li>test 2</li>
      </ul>
...
<script>
import cha_hospital from "@/assets/images/1.png";
